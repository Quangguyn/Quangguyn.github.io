...
function displayProducts(products) {
  ...
  if (products.length === 0) {
    ...
    paginationContainer.innerHTML = ""; // Nếu không có sản phẩm, không hilet currentPage = 1;
  ...
  productsToShow.forEach((product) => {
    const productCard = `
      ...
      product.name
          ...
          <div class="card-footer py-4 pt-0 border-top-0 bg-transparent d-flex">
            <div class="me-3">
              <button class="add-button btn btn-outline-dark mt-auto" data-bs-toggle="modal" data-bs-target="#addBookModal">Thêm vào giỏ</button>
            </div>
            <div class="text-start">
              <a class="btn btn-dark mt-auto" href="">Mua ngay</a>
            </div>
